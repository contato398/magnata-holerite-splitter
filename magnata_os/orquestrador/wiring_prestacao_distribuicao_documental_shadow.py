...
def materializar_prestacao_distribuicao_documental_shadow(
    *,
    ...
    prestacao`) e chama o núcleo genérico (`materializar_distribuicao_
    documental_shadow`, intocado) -- nenhuma lógica de resolução,
    materialização, preview, autorização ou persistência é duplicada
    aqui; este módulo só monta e repassa."""
