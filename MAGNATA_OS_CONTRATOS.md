...
| `Colaborador`/`destinatario_id` | casamento por nome completo | `app.py:1421-1465` | nome não é identificador confiável (incidente real de colisão de identidade por casamento de nome) | usar CPF como chave primária de casamento; nome só como sinal auxiliar de baixa confiança |
